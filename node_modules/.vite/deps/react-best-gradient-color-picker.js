...
var require_tinycolor = __commonJS({
  "node_modules/tinycolor2/tinycolor.js"(exports, module) {
    (function(Math2) {
      ...
      function tinycolor7(color2, opts) {
        color2 = color2 ? color2 : "";
        opts = opts || {};
        if (color2 instanceof tinycolor7) {
          return color2;
        }
        if (!(this instanceof tinycolor7)) {
          return new tinycolor7(color2, opts);
        }
      ...
      tinycolor7.fromRatio = function(color2, opts) {
      ...
      function desaturate(color2, amount) {
        ...
        var hsl2 = tinycolor7(color2).toHsl();
        hsl2.s -= amount / 100;
        hsl2.s = clamp01(hsl2.s);
        return tinycolor7(hsl2);
      }
      ...
      function greyscale(color2) {
        return tinycolor7(color2).desaturate(100);
      }
      ...
      function triad(color2) {
        ...
        return [
          tinycolor7(color2),
          tinycolor7({ h: (h + 120) % 360, s: hsl2.s, l: hsl2.l }),
          tinycolor7({ h: (h + 240) % 360, s: hsl2.s, l: hsl2.l })
        ];
      }
      function tetrad(color2) {
        ...
        return [
          tinycolor7(color2),
          tinycolor7({ h: (h + 90) % 360, s: hsl2.s, l: hsl2.l }),
          tinycolor7({ h: (h + 180) % 360, s: hsl2.s, l: hsl2.l }),
          tinycolor7({ h: (h + 270) % 360, s: hsl2.s, l: hsl2.l })
        ];
      }
      function splitcomplement(color2) {
        ...
        return [
          tinycolor7(color2),
          tinycolor7({ h: (h + 72) % 360, s: hsl2.s, l: hsl2.l }),
          tinycolor7({ h: (h + 216) % 360, s: hsl2.s, l: hsl2.l })
        ];
      }
...
var gradientParser = (input = "") => {
  ...
  function matchHexColor() {
    ...
    if (hexObj == null ? void 0 : hexObj.value) {
      const { r, g, b, a: a2 } = (0, import_tinycolor2.default)(hexObj == null ? void 0 : hexObj.value).toRgb();
      return {
        value: `rgba(${r}, ${g}, ${b}, ${a2})`
      };
    }
  ...
  function matchLiteralColor() {
    ...
    if (litObj == null ? void 0 : litObj.value) {
      const { r, g, b, a: a2 } = (0, import_tinycolor2.default)(litObj == null ? void 0 : litObj.value).toRgb();
      return {
        value: `rgba(${r}, ${g}, ${b}, ${a2})`
      };
    }
  ...
  function matchColorStop() {
    ...
    color2.left = parseInt((_a = matchDistance()) == null ? void 0 : _a.value);
    return color2;
  }
  ...
  const convertHsl = (val) => {
    ...
    const { r, g, b, a: a2 } = (0, import_tinycolor2.default)({
      h: hsl2[0],
      s: hsl2[1],
      l: hsl2[2],
      a: hsl2[3] || 1
...
var low = (color2) => {
  return color2.value.toLowerCase();
};
var high = (color2) => {
  return color2.value.toUpperCase();
};
var getColors = (value) => {
...
var objectToString = (value) => {
  ...
  if (typeof value === "string") {
    ...
    if ((_a = value == null ? void 0 : value.type) == null ? void 0 : _a.includes("gradient")) {
      const sorted = (_b = value == null ? void 0 : value.colorStops) == null ? void 0 : _b.sort((a2, b) => (a2 == null ? void 0 : a2.left) - (b == null ? void 0 : b.left));
      ...
      const color2 = ((_e = value == null ? void 0 : value.colorStops[0]) == null ? void 0 : _e.value) || "rgba(175, 51, 242, 1)";
      return color2;
    }
  }
};
...
function PickerContextWrapper({ value, classes, children, onChange, squareWidth, hideOpacity, squareHeight }) {
  ...
  const createGradientStr = (newColors) => {
    const sorted = newColors.sort((a2, b) => a2.left - b.left);
...
var usePaintBright = (canvas, h, s, squareWidth) => {
  (0, import_react2.useEffect)(() => {
    ...
    if (ctx) {
      ...
      const gradient = ctx.createLinearGradient(0, 0, squareWidth, 0);
      for (let i = 0; i <= 100; i += 10) {
        const hsl2 = (0, import_tinycolor23.default)({ h, s, v: i });
        gradient.addColorStop(i / 100, hsl2.toHslString());
      }
      ctx.fillStyle = gradient;
      ctx.fill();
    }
...
var Hue = () => {
  ...
  const handleHue = (e2) => {
    const newHue = getHandleValue(e2) * 3.6;
  ...
  return import_react3.default.createElement(
    ...
    import_react3.default.createElement("canvas", { ref: barRef, height: "14px", width: `${squareWidth}px`, onClick: (e2) => handleClick(e2), style: { position: "relative", borderRadius: 14, verticalAlign: "top" } })
  );
};
var Hue_default = Hue;
...
var Input = ({ value, callback, max = 100, label }) => {
  ...
  const onChange = (e2) => {
    const newVal = formatInputValues(parseFloat(e2.target.value), 0, max);
    setTemp(newVal);
    callback(newVal);
  };
  return import_react4.default.createElement(
    "div",
    { style: { width } },
    import_react4.default.createElement("input", { value: temp, id: "rbgcp-input", onChange: (e2) => onChange(e2), className: classes.rbgcpInput }),
    import_react4.default.createElement("div", { className: classes.rbgcpInputLabel }, label)
  );
};
var HexInput = ({ opacity: opacity2 }) => {
  ...
  const handleHex = (e2) => {
    const tinyHex = (0, import_tinycolor25.default)(e2.target.value);
    setNewHex(e2.target.value);
    if (tinyHex.isValid()) {
      const { r, g, b } = tinyHex.toRgb();
      const newColor = `rgba(${r}, ${g}, ${b}, ${opacity2})`;
  ...
  return import_react4.default.createElement(
    "div",
    { style: { width: "23%" } },
    import_react4.default.createElement("input", { value: newHex, onBlur: hexBlur, onFocus: hexFocus, id: "rbgcp-hex-input", onChange: (e2) => handleHex(e2), className: `${classes.rbgcpInput} ${classes.rbgcpHexInput}` }),
...
var Square = () => {
  ...
  const handleColor = (e2) => {
    const onMouseMove = (0, import_lodash.default)(() => {
      const [x2, y2] = computePickerPosition(e2);
      if (x2 && y2) {
  ...
  return import_react6.default.createElement(
    ...
    import_react6.default.createElement(
      "div",
      { onMouseUp: stopDragging, onTouchEnd: stopDragging, onMouseDown: handleCanvasDown, onTouchStart: handleCanvasDown, onMouseMove: (e2) => handleMove(e2), style: { position: "relative", cursor: "ew-cross" } },
      ...
      import_react6.default.createElement(
        "div",
        { className: classes.rbgcpCanvasWrapper, style: { height: squareHeight }, onClick: (e2) => handleClick(e2) },
...
var Opacity = () => {
  ...
  return import_react7.default.createElement(
    "div",
    { onMouseDown: handleDown, onMouseMove: (e2) => handleMove(e2), style: {
      height: 14,
      marginTop: 17,
      marginBottom: 4,
      cursor: "ew-resize",
    ...
    import_react7.default.createElement("div", { style: { background: bg }, onClick: (e2) => handleClick(e2), className: classes.rbgcpOpacityOverlay })
  );
};
...
var Dropper = ({ onSelect }) => {
  ...
  return import_react11.default.createElement(
    ...
    coverUp && import_react11.default.createElement(
      Portal_default,
      null,
      import_react11.default.createElement("div", { onClick: (e2) => getColorLegacy(e2), className: classes.rbgcpEyedropperCover })
    )
  );
};
...
var AdvBar = ({ value, callback, reffy, openAdvanced, label }) => {
  ...
  return import_react12.default.createElement(
    ...
    import_react12.default.createElement(
      "div",
      { onMouseMove: (e2) => handleMove(e2), className: `${classes.cResize} ${classes.psRl}` },
      ...
      }, onMouseMove: (e2) => handleMove(e2), onClick: (e2) => handleClick(e2) }, label),
      import_react12.default.createElement("canvas", { ref: reffy, height: "14px", width: `${squareWidth}px`, onClick: (e2) => handleClick(e2), style: { position: "relative", borderRadius: 14 } })
    )
  );
};
...
var ComparibleColors = ({ openComparibles }) => {
  ...
  const handleClick = (tiny) => {
    const { r, g, b, a: a2 } = tiny.toRgb();
    handleChange(`rgba(${r},${g},${b},${a2})`);
  };
...
var StopPicker = () => {
  ...
  return import_react14.default.createElement(
    ...
    import_react14.default.createElement("input", { value: currentLeft, id: "rbgcp-stop-input", onChange: (e2) => handleMove(e2.target.value), className: `${classes.rbgcpControlInput} ${classes.rbgcpStopInput}` })
  );
};
var DegreePicker = () => {
  const { classes, degrees, onChange, value } = usePicker();
  const handleDegrees = (e2) => {
    const newValue = formatInputValues(e2.target.value, 0, 360);
    const remaining = value.split(/,(.+)/)[1];
  ...
  return import_react14.default.createElement(
    ...
    import_react14.default.createElement("input", { value: degrees, id: "rbgcp-degree-input", onChange: (e2) => handleDegrees(e2), className: `${classes.rbgcpControlInput} ${classes.rbgcpDegreeInput}` }),
...
var InputTypeDropdown = ({ openInputType, setOpenInputType }) => {
  ...
  return import_react15.default.createElement(
    ...
    import_react15.default.createElement("div", { onClick: (e2) => handleInputType(e2, "rgb"), className: modalBtnStyles(inputType === "rgb", classes) }, "RGB"),
    import_react15.default.createElement("div", { onClick: (e2) => handleInputType(e2, "hsl"), className: modalBtnStyles(inputType === "hsl", classes) }, "HSL"),
    import_react15.default.createElement("div", { onClick: (e2) => handleInputType(e2, "hsv"), className: modalBtnStyles(inputType === "hsv", classes) }, "HSV"),
    import_react15.default.createElement("div", { onClick: (e2) => handleInputType(e2, "cmyk"), className: modalBtnStyles(inputType === "cmyk", classes) }, "CMYK")
  );
};
...
var Handle = ({ left, i, setDragging, setInFocus }) => {
  ...
  return import_react16.default.createElement(
    "div",
    { tabIndex: 0, onBlur: handleBlur, onFocus: handleFocus, id: `gradient-handle-${i}`, onMouseDown: (e2) => handleDown(e2), className: classes.rbgcpGradientHandleWrap, style: { left: (left || 0) * leftMultiplyer } },
...
var GradientBar = () => {
  ...
  function force90degLinear(color2) {
    return color2.replace(/(radial|linear)-gradient\([^,]+,/, "linear-gradient(90deg,");
  }
  const addPoint = (e2) => {
    var _a;
    const left = getHandleValue(e2);
    const newColors = (_a = [
      ...colors.map((c) => ({ ...c, value: low(c) })),
      { value: currentColor, left }
    ]) == null ? void 0 : _a.sort((a2, b) => a2.left - b.left);
    createGradientStr(newColors);
  };
  ...
  const handleMove = (e2) => {
    if (dragging) {
      handleGradient(currentColor, getHandleValue(e2));
    }
  };
  const handleKeyboard = (e2) => {
    if (isGradient) {
      if (e2.keyCode === 8) {
        if (inFocus === "gpoint") {
          deletePoint();
  ...
  return import_react16.default.createElement(
    ...
    import_react16.default.createElement("div", { style: {
      ...
      borderRadius: 10
    }, onMouseDown: (e2) => handleDown(e2), onMouseMove: (e2) => handleMove(e2) }),
...
var useColorPicker = (value, onChange) => {
  ...
  const createGradientStr = (newColors) => {
    const sorted = newColors.sort((a3, b2) => a3.left - b2.left);
    const colorString = sorted == null ? void 0 : sorted.map((cc) => `${cc == null ? void 0 : cc.value} ${cc.left}%`);
  ...
  const setR = (newR) => {
    ...
    handleChange(`rgba(${newVal}, ${g}, ${b}, ${a2})`);
  };
  const setG = (newG) => {
    const newVal = formatInputValues(newG, 0, 255);
    handleChange(`rgba(${r}, ${newVal}, ${b}, ${a2})`);
  };
  const setB = (newB) => {
    const newVal = formatInputValues(newB, 0, 255);
    handleChange(`rgba(${r}, ${g}, ${newVal}, ${a2})`);
  };
  const setA = (newA) => {
